...
class Custom3DDataset(Dataset):
    def __init__(self, root_dir, include_classes, sequence_length=16, sampling="multi-uniform", transform=None , max_seq=3 ):
        ...
        # self.classes = all_classes [: (len(all_classes)* include_classes)//100]
        self.classes = random.sample(all_classes, (len(all_classes)* include_classes)//100)
...
class Custom4DDataset(Dataset):
    def __init__(self, rgb_root_dir, depth_root_dir, include_classes, cam_view, sequence_length=16, sampling="single-uniform", transform=None ,depth_transform=depth_transforms, max_seq=3):
...
# Test datasets
# train_dataset = Custom3DDataset(root_dir='/mnt/data-tmp/ghazal/DARai_DATA/l2_depth_dataset/train/depth_1',
#                                 transform=train_transforms , include_classes = 100)
# print(f"Dataset size: {len(train_dataset)}")
# test_dataset = Custom3DDataset(root_dir='/mnt/data-tmp/ghazal/DARai_DATA/rgb_dataset/test/cam_1', transform=test_transforms)
