...
# Load config file
def load_config(config_file='/home/ghazal/Activity_Recognition_benchmarking/timeseries_unimodal/configs/bio_5d_config.yaml'):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Biomonitor Classifier with config.")
