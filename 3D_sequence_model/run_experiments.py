...
if __name__ == "__main__":
    ...
    plt.savefig(os.path.join(args.base_dir ,"figures",
                             f"averaged_training_val_loss_acc_{args.modality}_{args.backbone}_{args.sampling}_ep {args.epochs}_B {args.batch_size}_{args.env}_{args.cam_view}_{args.data_dir.split('/')[-1]}.png"))
    plt.show()
