...
if __name__ == "__main__":
    ...
    save_results_to_json(average_result,
                         os.path.join(args.base_dir ,"results",
                                      f"rgbd_average seed result_{args.sampling}_ep {args.epochs}_B {args.batch_size}_{args.env}_{args.cam_view}.json"))
    # Plotting
    ...
    plt.savefig(os.path.join(args.base_dir ,"figures",
                             f"rgbd_averaged_training_val_loss_acc_{args.sampling}_ep {args.epochs}_B {args.batch_size}_{args.env}_{args.cam_view}_{args.data_dir.split('/')[-1]}.png"))
    plt.show()
